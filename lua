...
local theme = getgenv().theme or {
    ...
    TopBar = Color3.fromRGB(255, 25, 255),
    ...
    NotSelectedTab = Color3.fromRGB(25, 0, 25), --> shows on all OTHER tabs
...
do
    function library.init(title, version, id, position, size)
        ...
        local size = size or UDim2.new(0, 450, 0, 550)
